...
import (
    ...
    "github.com/cisco-open/go-lanai/pkg/security/saml"
...
func TestWithMockedServer(t *testing.T) {
	...
	test.RunTest(context.Background(), t,
		...
		apptest.WithModules(Module, logout.Module, request_cache.Module, samlctx.Module, access.Module, errorhandling.Module),
		apptest.WithDI(di),
