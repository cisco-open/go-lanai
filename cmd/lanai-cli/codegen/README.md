...
- Reads an [openAPI spec](https://spec.openapis.org/oas/latest.html) and:
  ...
  - [See example generated files](./testdata/golden/v2)
...
[test golden files](./testdata/golden) when given an openAPI contract
...
By default, codegen uses the set of templates defined in [template/src](./template/src),
...
- `contract` - path to the openAPI contract. Supports OpenAPI 3.0, see an example [here.](./testdata/test-codegen-v1.yml)
